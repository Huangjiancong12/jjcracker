  ...
  <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="index.html">JJ<span>Crackers</span></a></h1>
                    </div>
                </div>
...
<div> 
    <div class="text-center">
        <br>
        <h2>Thankyou <?= h($cust_name) ?> for your order! </h2>
        <h2>Here is a summary of your order, we hope you enjoy your world class crackers!</h2>
        <p>Shipping Address: <?= h($cust_address) ?></p>
    </div>
</div>
<div class="col-md-12"> 
    <div class="col-md-8" style="padding-top: 20px; padding-left: 25%">
