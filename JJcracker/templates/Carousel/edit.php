      ...
      <div class="row">
        <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            <div class="row">
              <div class="col-12">
                <h2 class="tm-block-title d-inline-block">Edit Carousel Slide</h2>
              </div>
            </div>
            <div class="row tm-edit-product-row">
              <div class="col-xl-6 col-lg-6 col-md-12">
                <?= $this->Form->create($carousel, ['type'=>'file'], ['class' => 'carouse-form']) ?>

                  <div class="form-group mb-3">
                    

                    <?= $this->Form->control('change_photo', ['type'=>'file'],['class'=>'form-control validate']); ?>

                  </div>

                  <div class="form-group mb-3">
                    <?= $this->Form->control('heading',['class' => 'custom-select tm-select-accounts']); ?>
                  </div>
              ...
              <div class="col-xl-6 col-lg-6 col-md-12 mx-auto mb-4">
                ...
                <?= $this->Html->image('carousel/' . $carousel->photo, ['class'=> 'tm-product-img-dummy mx-auto']) ?>
              </div>
              <div class="col-12">
